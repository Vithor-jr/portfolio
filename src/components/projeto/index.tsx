...
export default function Projeto({ titulo, image, link, descricao, ano, video, tecnologias, isFirst, isLast }: ProjetoProps) {
          ...
          <div className="flex min-[900px]:h-[calc(50vw*(503/758))] max-[900px]:mt-[20px] flex-1 flex-col justify-between">
            ...
            <div className="flex flex-col gap-4 mt-5 overflow-hidden ">
              <div className="gap-5 flex flex-row">
                <a className="flex-row flex items-center gap-1 cursor-pointer decoration-black dark:decoration-white hover:underline">
                  ...
                  <a className="flex-row flex items-center gap-1 cursor-pointer hover:underline decoration-black dark:decoration-white">
