...
const ItemLanguage = ({image, label, href}:{image:string, label:string, href:string}) => {
	return(
		<div  className='flex flex-col items-center'>
			<a href={href} target="_blank" rel="noopener noreferrer" className='cursor-pointer dark:hover:bg-[rgba(255,255,255,0.1)] hover:bg-[rgba(0,0,0,0.1)] rounded-[5px] p-1'>
				<Image src={image} className={`max-[601px]:h-[12vw] max-[900px]:h-[6vw] h-[3vw] justify-self-start ${styles.noselect}`} alt={label}/>
			</a>
			<h1 className='text-[1vw] max-[900px]:text-[1.5vw] max-[601px]:text-[3.4vw] font-medium text-black dark:text-white'>{label}</h1>
		</div>
	)
}
		...
		<section className="w-full mt-[16vw] z-2 flex items-center flex-col" id="sobre">
			<div className='flex flex-col items-center'>
				...
				<div className='flex flex-row justify-between w-full items-center'>
					<motion.p className='max-[600px]:text-[1.5vw] text-[0.8vw] dark:text-[rgba(255,255,255,0.5)] text-[rgba(0,0,0,0.7)]'>2022</motion.p>
					<motion.div className='h-[0.1vw] dark:bg-[rgba(255,255,255,0.5)] bg-[rgba(0,0,0,0.7)] w-full'/>
					<motion.p className='max-[600px]:text-[1.5vw] text-[0.8vw] dark:text-[rgba(255,255,255,0.5)] text-[rgba(0,0,0,0.7)]'>2025</motion.p>
				</div>
			</div>

			<div className='flex mt-16 flex-row max-[900px]:flex-col px-5 justify-between w-full items-center'>
				<p className='text-black dark:text-white w-[30%] max-[900px]:w-full max-[900px]:mb-5 max-[900px]:text-center'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
				...
				<div className='flex flex-row flex-wrap max-[600px]:w-[calc(90vw)] max-[600px]:gap-[6vw] max-[900px]:w-[calc(80vw+20px)] w-[calc(60vw+20px)] gap-x-[20px] gap-y-[2vw]'>
					<div className={`${styles.container} dark:shadow-[inset_0px_0px_1px_white] shadow-[inset_0px_0px_1px_black]  bg-[rgba(0,0,0,0.1)] dark:bg-[rgba(255,255,255,0.1)]`}>
						...
						<div className='flex flex-row mt-[1vw] relative'>
							<div className='flex max-[601px]:mt-[1vw] mt-[0.5vw] max-[601px]:w-[5vw] w-[2vw] justify-center'>
								<div className='w-[2px] bg-[#1F3EF5]'/>
								<div className='w-[1vw] h-[1vw] max-[601px]:w-[3vw] max-[601px]:h-[3vw] absolute bg-[#1F3EF5] rounded-full'/>
								<div className='w-[1vw] h-[1vw] max-[601px]:w-[3vw] max-[601px]:h-[3vw] absolute bg-[#1F3EF5] rounded-full top-[62%]'/>
							</div>

							<div className='h-full'>
								<h1 className='text-[1.2vw] font-bold max-[900px]:text-[1.5vw] max-[601px]:text-[3.7vw] text-black dark:text-white'>Fundação Matias Machline</h1>
								<p className='text-[1vw] max-[900px]:text-[1.5vw] max-[601px]:text-[3vw] font-light text-[rgba(0,0,0,0.7)] dark:text-[rgba(255,255,255,0.5)]'>2022 | 2024</p>
								<h3 className='text-[1vw] max-[900px]:text-[1.5vw] max-[601px]:text-[3.4vw] font-medium text-black dark:text-white'>Técnico em informática</h3>
							
								<h1 className='mt-[10%] text-[1.2vw] font-bold max-[900px]:text-[1.5vw] max-[601px]:text-[3.7vw] text-black dark:text-white'>Universidade Federal do Amazonas</h1>
								<h2 className='text-[1vw] max-[900px]:text-[1.5vw] max-[601px]:text-[3.4vw] font-light text-[rgba(0,0,0,0.7)] dark:text-[rgba(255,255,255,0.5)]'>2025 | 2028</h2>
								<h3 className='text-[1vw] max-[900px]:text-[1.5vw] max-[601px]:text-[3.4vw] font-medium text-black dark:text-white'>Graduando em Ciência da computação</h3>
							</div>
						</div>
					</div>
					...
					<div className={`${styles.container} flex flex-col dark:shadow-[inset_0px_0px_1px_white] shadow-[inset_0px_0px_1px_black]  bg-[rgba(0,0,0,0.1)] dark:bg-[rgba(255,255,255,0.1)]`}>
						...
						<div className='flex gap-2 items-center'>
							...
							<h1 className='font-bold text-[1.5vw] max-[600px]:text-[4vw] max-[900px]:text-[2vw] text-[#1F3EF5]'>Linguagens</h1>
						</div>

						<div className='flex-1 mx-[-1vw] mt-[1vw] grid grid-cols-4 grid-rows-2'>
								<ItemLanguage href='https://sqldocs.org/' image={Sql} label='Sql'/>
								<ItemLanguage href='https://docs.python.org/3/' image={python} label='Python'/>
								<ItemLanguage href='https://devdocs.io/javascript/' image={Javascript} label='Javascript'/>
								<ItemLanguage href='https://www.typescriptlang.org/docs/' image={Typescript} label='Typecript'/>

								<ItemLanguage href='https://devdocs.io/css/' image={css} label='CSS'/>
								<ItemLanguage href='https://devdocs.io/html/' image={html} label='HTML'/>
								<ItemLanguage href='https://devdocs.io/c/' image={c} label='C'/>
								<ItemLanguage href='https://docs.oracle.com/en/java/' image={Java} label='Java'/>
						</div>
					...
					<div className={`${styles.container} dark:shadow-[inset_0px_0px_1px_white] shadow-[inset_0px_0px_1px_black]  bg-[rgba(0,0,0,0.1)] dark:bg-[rgba(255,255,255,0.1)]`}>
						...
						<div className='flex gap-2 items-center'>
							...
							<h1 className='font-bold text-[1.5vw] max-[600px]:text-[4vw] max-[900px]:text-[2vw] text-[#1F3EF5]'>Back-end</h1>
						</div>
					
						<div className='flex-1 flex flex-row justify-between items-center pt-2'>
							<div className='flex flex-col items-center gap-2'>
								<ItemBackend href='https://www.postgresql.org/docs/' image={Postgree} label='PostgreeSQL'/>
								<ItemBackend href='https://dev.mysql.com/doc/' image={MySql} label='Mysql'/>
							</div>

							<div className='flex flex-col items-center gap-2'>
								<ItemBackend href='https://www.mongodb.com/pt-br/docs/?msockid=17db215a5b8366663f1c32e55a156716' image={MongoDB} label='MongoDb'/>
								<ItemBackend href='https://nextjs.org/docs/pages/building-your-application/routing/api-routes' image={NextJs} label='Next.js'/>
							</div>

							<div className='flex flex-col items-center gap-2'>
								<ItemBackend href='https://docs.nestjs.com/' image={NestJS} label='Nest.js'/>
								<ItemBackend href='https://expressjs.com/' image={Express} label='Express.js'/>	</div>					
							</div>
					</div>
					...
					<div className={`${styles.container} dark:shadow-[inset_0px_0px_1px_white] shadow-[inset_0px_0px_1px_black]  bg-[rgba(0,0,0,0.1)] dark:bg-[rgba(255,255,255,0.1)]`}>
						...
						<div className='flex gap-2 items-center'>
							...
							<h1 className='font-bold text-[1.5vw] max-[600px]:text-[4vw] max-[900px]:text-[2vw] text-[#1F3EF5]'>Front-end</h1>
						</div>
						
		
						<div className='flex-1 flex flex-row justify-between items-center'>
							<ItemFrontEnd href='https://developer.android.com/develop?hl=pt-br' image={AndroidStudio} label='Android Studio'/>
							<ItemFrontEnd href='https://reactnative.dev/' image={ReactNativve} label='React Native'/>
							<ItemFrontEnd href='https://nextjs.org/docs' image={NextJs} label='Next.js'/>	
						</div>	
